...
- **Languages**: 
  - `TypeScript/JavaScript` - Standard for front-end and full-stack web.
  - `Python` - Standard for data, ML, backend scripts, and RAG architectures.
  - `HTML/CSS` - Ubiquitous for UI.
- **Frameworks/Platforms**:
  - `Node.js` - Default JavaScript runtime.
  - `Docker` - Standardized containerization for services.
...
- **MCP (Model Context Protocol)**
  - Heavily used in AI integrations.
...
- **C/C++**
  - Crucial for embedded systems firmware and low-level performance.
- **Unity / C#**
  - Used for robust 3D/physics simulations. Competing with Godot for game engine share.
